  ...
  return (
    ...
    <div className="md:padding-x p-2 flex flex-col ">
      <div className="flex max-lg:justify-center max-lg:items-center flex-col lg:flex-row gap-10 ">
        <h2 className="flex items-center justify-center text-center text-[40px] bg-lime-green font-grotesk py-[10px] rounded-md border-[5px] border-lime-green px-[7px] font-medium max-sm:text-[30px]">Services</h2>
        <p className="font-grotesk flex items-center text-lg md:w-[580px] max-sm:text-center max-sm:text-[16px]">At our digital marketing agency, we offer a range of services to help businesses grow and succeed online. These services include:</p>
      </div>
      ...
      <div className="flex flex-row justify-between items-center flex-1 w-full bg-gray-100 rounded-[45px] mt-[123px] px-[60px] mb-[23]">
        <div className="flex flex-col gap-[26px] py-[60px] max-w-[500px]">
          <h3 className="font-grotesk text-[30px] max-sm:text-[25px]">Let's make things happen</h3>
