  ...
  return (
    <section className="w-full min-h-screen max-container md:padding-x px-4 mt-[70px] ">
      ...
      <div className="flex flex-col xl:w-[531px] xl:h-[481] gap-[35px]">
        <h1 className="text-[60px] font-medium font-grotesk max-sm:text-center">Navigating the <br /> digital landscape <br /> for success</h1>
        <p className="text-xl font-grotesk leading-[28px] max-sm:text-center">Our digital marketing agency helps businesses grow and succeed online through a range of services including SEO, PPC, social media marketing, and content creation.</p>
        <div className="w-[264px] h-[68px] pb-[34px] flex justify-center items-center">
