...
const Awards = () => {
  return (
    ...
    <div className="flex max-lg:justify-center max-lg:items-center flex-col lg:flex-row gap-10 ">
      ...
      <p className="font-grotesk flex items-center text-lg max-sm:text-center md:w-[580px]">At Positivus, our commitment to excellence has been recognized by idustry leadrs. Here are some of our proudest acheivements: </p>
    </div>
      ...
      {Recognition.map((recognition, index) => (
        <div key={index} className="flex flex-col items-center bg-light-gray rounded-[45px] py-[30px] px-[15px] border-rich-black border-[1px] border-b-[4px]">
          ...
          <div className="flex flex-col mt-[20px]">
            <h3 className="font-grotesk font-bold text-[20px]">{recognition.label}</h3>
